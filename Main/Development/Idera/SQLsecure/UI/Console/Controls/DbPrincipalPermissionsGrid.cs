...
{
    public partial class DbPrincipalPermissionsGrid : UserControl
    {
        #region Columns
        ...
        private void updateGrid()
        {
            ...
            using (DataSet ds = Sql.DatabasePrincipalPermissions.GetDatabasePrincipalPermissions(m_Tag))
            {
                // Update progress.
        ...
        {
            _ultraGridPrintDocument.DocumentName = "Permissions assigned to " + m_Tag.DatabaseName + "." + m_Tag.ObjectName;
