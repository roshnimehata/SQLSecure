...
{
    public partial class Report_Filters : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_Filters");
        ...
        public Report_Filters()
        {
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_Filters;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_Filters;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_getauditfilters";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_getauditfilters";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Data Collection Filters");
            ...
            Param[0] = new ReportParameter("ReportTitle", m_Title);
