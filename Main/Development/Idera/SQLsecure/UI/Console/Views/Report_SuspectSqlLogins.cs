...
{
    public partial class Report_SuspectSqlLogins : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_SuspectSqlLogins");
        ...
        public Report_SuspectSqlLogins()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_SuspectSqlLogins;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_SuspectSqlLogins;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_suspectsqllogins";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_suspectsqllogins";
