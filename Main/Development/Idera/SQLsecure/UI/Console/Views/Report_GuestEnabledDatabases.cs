...
{
    public partial class Report_GuestEnabledDatabases : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_GuestEnabledDatabases");
        ...
        public Report_GuestEnabledDatabases()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_GuestEnabledDatabases;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_GuestEnabledDatabases;
        ...
        // Main Report        
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_getguestenabledservers";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_getguestenabledservers";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Guest Enabled Servers");
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(Program.gController.Repository.ConnectionString))
                {
                    ...
                    SqlParameter paramServerName = new SqlParameter(SqlParamServer, getServerName(_comboBox_Server.Text));
            ...
            Param[2] = new ReportParameter("connectionname", _comboBox_Server.Text);
