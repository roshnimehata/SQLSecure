...
{
    public partial class Report_SuspectWindowsAccounts : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_SuspectWindowsAccounts");
        ...
        public Report_SuspectWindowsAccounts()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_SuspectWindowsAccounts;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_SuspectWindowsAccounts;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_orphanedlogins";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_orphanedlogins";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Orphaned Logins");
