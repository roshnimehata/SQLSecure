...
{
    public partial class Report_VulnerableFixedRoles : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_VulnerableFixedRoles");
        ...
        public Report_VulnerableFixedRoles()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_VulnerableFixedRoles;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_VulnerableFixedRoles;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_dbuserfixedrole";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_dbuserfixedrole";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Fixed Roles assigned to Public");
