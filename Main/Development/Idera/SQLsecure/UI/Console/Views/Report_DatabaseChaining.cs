...
{
    public partial class Report_DatabaseChaining : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_DatabaseChaining");
        ...
        public Report_DatabaseChaining()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_DatabaseChaining;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_DatabaseChaining;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_checkdbchaining";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_checkdbchaining";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Check Database Chaining");
