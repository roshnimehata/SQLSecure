...
{
    public partial class Report_MixedModeAuthentication : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_MixedModeAuthentication");
        ...
        public Report_MixedModeAuthentication()
        {
            InitializeComponent();
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_MixedModeAuthentication;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_MixedModeAuthentication;
        ...
        // Main Report
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_authentication";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_authentication";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Mixed Mode Authentication");
