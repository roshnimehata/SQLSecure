...
{
    public partial class Report_ServerRoles : Idera.SQLsecure.UI.Console.Controls.BaseReport, Interfaces.IView
    {
        private static LogX logX = new LogX("Idera.SQLsecure.UI.Console.Views.Report_ServerRoles");
        ...
        public Report_ServerRoles()
        {
            ...
            m_Title                     =
                ...
                _label_Status.Text      = Utility.Constants.ReportTitle_ServerRoles;

            //set the description and getting started text
            _label_Description.Text = Utility.Constants.ReportSummary_ServerRoles;
        ...
        // Main Report        
        private const string QueryDataSource = @"SQLsecure.dbo.isp_sqlsecure_report_serverroles";
        private const string DataSourceName = @"ReportsDataset_isp_sqlsecure_report_serverroles";
        ...
        protected internal override void runReport()
        {
            ...
            logX.loggerX.Info(@"Retrieve data for report Server Roles");
