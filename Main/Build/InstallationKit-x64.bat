...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit-x64.abs /build BuildCompileOutput\IderaSQlsecureInstallationKit-x64.exe /silent /zip BuildCompileOutput\SQLsecure-x64.zip
