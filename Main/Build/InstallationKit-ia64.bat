...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit-ia64.abs /build BuildCompileOutput\IderaSQlsecureInstallationKit-ia64.exe /silent /zip BuildCompileOutput\SQLsecure-ia64.zip
