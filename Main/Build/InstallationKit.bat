...
rem _____________________________________________________________________
"c:\program files\Absolute Packager\absolute.exe" /abs InstallationKit.abs /build BuildCompileOutput\IderaSQlsecureInstallationKit.exe /silent /zip BuildCompileOutput\SQLsecure.zip
